...
/**
 * Servlet implementation class DonarFeedBack
 */
@WebServlet("/DonarFeedBack")
public class DonarFeedBack extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (status > 0) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/donar/donarfeedback.jsp");// relative path
