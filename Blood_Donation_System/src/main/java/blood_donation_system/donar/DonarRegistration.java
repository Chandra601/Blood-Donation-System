...
public class DonarRegistration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String id = request.getParameter("donarId");
		...
		try {
			...
			String insert_query = "insert into donar(donar_id, donar_pass, name, age, email, gender, phone, blood_group, city, date)values(?,?,?,?,?,?,?,?,?,?)";
			...
			if(status>0)
			{
				...
				RequestDispatcher rd = request.getRequestDispatcher("/donar/registration.jsp");
