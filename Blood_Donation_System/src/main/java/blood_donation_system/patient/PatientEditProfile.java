...
public class PatientEditProfile extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String strupdate = "update patient set patient_pass=?, name=?, age=?, email=?, gender=?, phone=?, blood_group=?, city=?, date=?";
			...
			if(status>0)
			{
				...
				RequestDispatcher rd = request.getRequestDispatcher("/patient/patient_editprofile.jsp");
