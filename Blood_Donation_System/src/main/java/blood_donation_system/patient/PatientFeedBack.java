...
/**
 * Servlet implementation class PatientFeedBack
 */
@WebServlet("/PatientFeedBack")
public class PatientFeedBack extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (status > 0) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("/patient/patient_feedback.jsp");// relative path
