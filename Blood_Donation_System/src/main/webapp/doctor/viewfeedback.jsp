...
<title>View FeedBack | Blood Donation System </title>
...
<%
	...
	if (doctname == null) {
		...
		ResultSet rs = DoctorTask.viewFeedBack(strsql);
	%>
<%@include file="/doctor/doctorheader.jsp"%>

	<div class="container-fluid">
		<h1 class="text-center text-success heading">All FeedBack List</h1>
	</div>
	<div class="container">
