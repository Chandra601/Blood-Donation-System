...
<title>View Donor Blood Donate List | Blood Donation System </title>
...
<%
	...
	if (doctname == null) {
		...
		String strsql = "select * from donar_donateblood";
		ResultSet rs = DoctorTask.viewDonarBloodDonateList(strsql);
	%>
<%@include file="/doctor/doctorheader.jsp"%>

	<div class="container-fluid">
		<h1 class="text-center text-success heading">All Donor Blood Donate List</h1>
	</div>
	<div class="container">
	<table class="table table-primary table-striped-columns">
		<thead>
			...
			<th scope="col">S No</th>
				...
				<th scope="col">Age</th>
				<th scope="col">Donate Blood Unit</th>
		...
		<tbody>
			...
			<tr class="table-dark">
				...
				<td><%=rs.getString("donar_name")%></td>
				<td><%=rs.getString("donar_phone")%></td>
				<td><%=rs.getString("donar_disease")%></td>
			    <td><%=rs.getString("donar_age")%></td>
			    <td><%=rs.getString("donar_unitblood")%></td>
			    <td><%=rs.getString("donar_blooddetails")%></td>
			</tr>
