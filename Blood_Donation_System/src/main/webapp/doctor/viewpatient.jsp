...
<title>View PatientList | Blood Donation System </title>
...
<%
	...
	if (doctname == null) {
		...
		ResultSet rs = DoctorTask.viewPatientList(strsql);
	%>
<%@include file="/doctor/doctorheader.jsp"%>

	<div class="container-fluid">
		<h1 class="text-center text-success heading">All Patient List</h1>
	</div>
	<div class="container">
	<table class="table table-primary table-striped-columns">
		...
		<tbody>
			...
			<tr class="table-dark">
				...
				<td><%=rs.getString("patient_pass")%></td>
