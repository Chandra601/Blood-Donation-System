...
<title>View DonorList | Blood Donation System </title>
...
<%
	...
	if (doctname == null) {
		...
		String strsql = "select * from donar";
		ResultSet rs = DoctorTask.viewDonarList(strsql);
	%>
<%@include file="/doctor/doctorheader.jsp"%>

	<div class="container-fluid">
		<h1 class="text-center text-success heading">All Donor List</h1>
	</div>
	<div class="container">
