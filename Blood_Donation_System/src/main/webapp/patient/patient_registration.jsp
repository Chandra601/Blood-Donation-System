...
%>
	...
	<div class="container register-form">
		<div class="row">
			<h1 class="text-center heading">Patient Registration</h1>
			<%if (message!= null){%>
		...
		<div class="form">
			...
			<form method="post" action="/Blood_Donation_System/PatientRegistration"
						...
						<div class="col-md-6">
							<div class="form-group mt-1">
								<input type="text" class="form-control" id="patientId"
									name="patientId" placeholder="Enter your patient id" required="required" />
								<div class="invalid-feedback">Please Enter Your PatientID</div>
							</div>
							<div class="form-group mt-1">
